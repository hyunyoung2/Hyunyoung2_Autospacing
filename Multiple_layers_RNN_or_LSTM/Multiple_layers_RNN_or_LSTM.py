...
# for cell
rnn_layers = 2
# you have to configure num_hidden_units list
num_hidden_units = [128, num_classes] #embedding_size
...
# make multiRNN
my_stacked_rnn_cell = tf.nn.rnn_cell.MultiRNNCell([make_cell(selected_rnn_type, num_hidden_units[i]) 
...
if selected_rnn_type == rnn_type[1]:
    my_initial = my_stacked_rnn_cell.zero_state(new_batch_size, dtype=tf.float32)
    
    outputs, state = tf.nn.dynamic_rnn(my_stacked_rnn_cell, x_inputs,
    ...
    outputs, state = tf.nn.dynamic_rnn(my_stacked_rnn_cell, x_inputs,
                                       ...
                                       dtype=tf.float32)
if selected_rnn_type == rnn_type[1]:
    print("The my_initial:{}".format(my_initial))
print("++++")
print("The my_stacked_rnn_cell:{}".format(my_stacked_rnn_cell))
